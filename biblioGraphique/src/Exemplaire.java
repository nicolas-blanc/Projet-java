...
public class Exemplaire implements Serializable {
	 ...
	 */
	private void setNumero(int numero) { //check nico
		_numero = numero;
	}
	...
	private void setDateReception(GregorianCalendar dateReception) {
		_dateReception = dateReception;//check nico
	}

	/**
	 * @param ouvrage l'ouvrage lié à l'exemplaire
	 */
	private void setOuvrage(Ouvrage ouvrage) {//check nico
		_ouvrage = ouvrage;
	} // Fin setOuvrage
	 ...
	 */
	public Ouvrage getOuvrage() {//check nico
		return _ouvrage;
	}
	 ...
	 */
	public int getNumero() {//check nico
		return _numero;
	}
	 ...
	 */
	public GregorianCalendar getDateReception() {//check nico
	 ...
	 */
	public int getStatut() {//check nico
		return _statut;
	}
	 ...
	 */
	public boolean estEmpruntable() {//check nico
	 ...
	 */
	public boolean estEnConsultation() {//check nico
	 ...
	 */
	public String libStatut() {//check nico
